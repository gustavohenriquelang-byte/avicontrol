...
import { toggleFarmActive } from "./actions";

export function FarmRowActions({ id, active }: { id: string; active: boolean }) {
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-1 w-40 rounded-md border border-hairline bg-card p-1 shadow-md">
          ...
          <button
            ...
            onClick={() =>
              start(async () => {
                await toggleFarmActive(id, !active);
                setOpen(false);
              })
            }
